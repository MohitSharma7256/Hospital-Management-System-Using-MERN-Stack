  ...
  return (
    <div className="hero container">
      <div className="banner">
        <h1>{title}</h1>
        <p>
          Shaan Hospital is a state-of-the-art multi-specialist hospital dedicated to providing
          ...
          care tailored to each patient's needs, ensuring a harmonious journey
